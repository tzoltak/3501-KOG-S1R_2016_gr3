...
plot(x, k, col = 2, lwd = 2,
     ...
     main = "Rozkłady wieku wśród polskich 18-latków")
...
```
  ...
  - Jaki odsetek obserwacji ma wartości zm. X większe niż 0?
```{r comment="", prompt=TRUE, collapse=TRUE}
...
Na następnych zajęciach odbędzie się kartkówka, sprawdzająca:
  ...
  2. Umiejętność odpowiadania na ww. pytania na podstawie odpowiednio anotowanego wykresu dystrybuanty lub funkcji gęstości prawdopodobieństwa.
  3. Znajomość najważniejszych własności rozkładu normalnego.
